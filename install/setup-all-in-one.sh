...
# logging
#docker run --name logspout -d --restart always -p 1095:80 -v /var/run/docker.sock:/var/run/docker.sock gliderlabs/logspout:latest syslog
...
popd
echo LockOnCRM is now deployed!
